...
servers:
  - url: https://{subdomain}.uazapi.com
    description: Servidor da API uazapiGO
    variables:
      subdomain:
        enum:
          - free
  ...
  schemas:
    ...
    ChatbotTrigger:
      ...
      properties:
        ...
        flow_id:
          type: string
          description: ID do fluxo. Obrigatório quando type='flow'
        quickReply_id:
          type: string
...
tags:
  ...
  - name: Proxy
    description: >
      ...
      Você pode manter esse padrão, configurar um proxy próprio via `proxy_url` ou usar seu celular android como proxy
      instalando o app em https://github.com/uazapi/silver_proxy_apk (APK direto:
      https://github.com/uazapi/silver_proxy_apk/raw/refs/heads/main/silver_proxy.apk).

      Se nada for enviado, seguimos no proxy interno. IPs são brasileiros; para clientes internacionais, considere um
      proxy da região do cliente.
  - name: Perfil
    description: |
...
paths:
          ...
          application/json:
            schema:
              ...
              properties:
                ...
                fingerprintProfile:
                  type: string
                  description: Perfil de fingerprint para emulação de navegador (opcional)
                  example: chrome
                browser:
                  type: string
                  description: Tipo de navegador para emulação (opcional)
                  example: chrome
              required:
                - name
      description: >
            ...
            schema:
              ...
              properties:
                phone:
                  type: string
                  description: >-
                    Número de telefone no formato internacional (ex: 5511999999999). Se informado, gera código de
              ...
              schema:
                ...
                properties:
                  ...
                  info:
                    type: string
                    example: >-
                      The device has been successfully disconnected from WhatsApp. A new QR code will be required for
                      the next connection.
        '401':
          description: Token inválido/expirado
        '404':
  ...
  /instance/proxy:
    get:
      ...
      description: >
        ...
        Observação: nossos IPs são brasileiros. Se você atende clientes internacionais, considere usar um proxy do
        país/região do seu cliente (via `proxy_url`).
            ...
            application/json:
              schema:
                ...
                properties:
                  enabled:
                    type: boolean
                    description: Indica se o proxy está habilitado
                  proxy_url:
                    type: string
                    description: URL do proxy (mascarada na resposta)
                  last_test_at:
                    type: integer
                    description: Timestamp (ms) do último teste
                  last_test_error:
                    type: string
                    description: Último erro de teste (se houver)
                  validation_error:
                    type: boolean
                    description: Indica se o último teste resultou em erro
        '401':
          description: Token inválido ou expirado
          content:
            application/json:
    ...
    post:
      ...
      description: >
        ...
        Se nada for enviado, seguimos no proxy interno. A URL é validada antes de salvar. A conexão pode ser reiniciada
        automaticamente para aplicar a mudança.


        Opcional: você pode usar seu celular android como proxy instalando o aplicativo disponibilizado pela uazapi em
        https://github.com/uazapi/silver_proxy_apk (APK direto:
        https://github.com/uazapi/silver_proxy_apk/raw/refs/heads/main/silver_proxy.apk).
      security:
        - token: []
      requestBody:
                ...
                properties:
                  ...
                  proxy:
                    ...
                    properties:
                      ...
                      proxy_url:
                        type: string
                        description: URL mascarada do proxy salvo
                      last_test_at:
                        type: integer
                        description: Timestamp (ms) do último teste
                      last_test_error:
            ...
            application/json:
              schema:
                ...
                properties:
                  error:
                    type: string
                    example: 'Falha ao validar proxy: ...'
        '401':
          description: Token inválido ou expirado
          content:
            application/json:
    ...
    delete:
      ...
      tags:
        - Proxy
      summary: Remover o proxy configurado
      description: |
      ...
      responses:
        '200':
          description: Configuração de proxy removida com sucesso
          content:
            application/json:
              schema:
                type: object
                properties:
                  ...
                  restart_requested:
                    type: boolean
                    description: Indica se a conexão foi reiniciada para aplicar a mudança
        '401':
          description: Token inválido ou expirado
          content:
            application/json:
              schema:
                ...
                properties:
                  error:
                    ...
                    example: Unauthorized
        '500':
          description: Erro interno do servidor ao deletar a configuração de proxy
          content:
            application/json:
              schema:
                type: object
            ...
            schema:
              ...
              properties:
                number:
                  type: string
                  description: >-
                    ID do chat para o qual a mensagem será enviada. Pode ser um número de telefone em formato
                    internacional, um ID de grupo (`@g.us`), um ID de usuário (com `@s.whatsapp.net` ou `@lid`).
                  example: '5511999999999'
                text:
                  type: string
          ...
          application/json:
            schema:
              ...
              properties:
                ...
                type:
                  type: string
                  description: Tipo de mídia (image, video, document, audio, myaudio, ptt, ptv, sticker)
                  enum:
                    - image
                    - video
                    - document
  ...
  /group/list:
    ...
    post:
      ...
      description: >
        Retorna uma lista com todos os grupos disponiveis para a instancia atual do WhatsApp, com opcoes de filtros e
        paginacao via corpo (POST).
          ...
          application/json:
            schema:
              ...
              properties:
                page:
                  type: integer
                  description: Numero da pagina para paginacao (padrao 1)
                  default: 1
                pageSize:
                  type: integer
                  description: Quantidade de resultados por pagina (padrao 50, maximo 1000)
                  default: 50
                limit:
                  type: integer
                  description: Alias opcional para `pageSize`
                offset:
                  type: integer
                  description: Deslocamento base zero; se informado recalcula a pagina
                  default: 0
                search:
                  type: string
                ...
                properties:
                  ...
                  pagination:
                    ...
                    properties:
                      ...
                      hasNextPage:
                        type: boolean
                        description: Indica se existe uma proxima pagina
                      hasPreviousPage:
                        type: boolean
                        description: Indica se existe pagina anterior
        '500':
          description: Erro interno do servidor ao recuperar grupos
          content:
            application/json:
                ...
                properties:
                  ...
                  pagination:
                    ...
                    properties:
                      ...
                      currentPage:
                        type: integer
                        description: Página atual (calculada a partir do offset)
                      totalPages:
                        type: integer
                        description: Total de páginas disponíveis
                      pageSize:
                        type: integer
                        description: Tamanho da página (igual ao limit)
                      hasNextPage:
                        type: boolean
          ...
          application/json:
            schema:
              ...
              properties:
                ...
                pageSize:
                  type: integer
                  description: Quantidade de resultados por pagina (padrao 100, maximo 1000)
                  default: 100
                limit:
                  type: integer
                  description: Alias opcional para `pageSize`
                offset:
                  type: integer
                  description: Deslocamento base zero para paginacao; se informado recalcula a pagina
                  default: 0
      responses:
        '200':
  ...
  /call/reject:
    post:
      ...
      description: >
        ...
        O body pode ser enviado vazio `{}`. Os campos `number` e `id` são opcionais e podem ser usados para especificar
            ...
            application/json:
              schema:
                ...
                properties:
                  ...
                  results:
                    type: object
                    description: Alias de response (compatibilidade)
                  updated:
                    type: integer
